...
<span className="col-span-1 ml-52 px-3 italic ">auctor augue mauris augue neque gravida
 in fermentum et sollicitudin ac orci phasellus egestas tellus rutrum tellus pellentesque 
 eu tincidunt tortor aliquam nulla facilisi cras fermentum odio eu feugiat pretium nibh ipsum consequat nisl</span>
...
<img src="src\assets\vuejs icon.jpg" className="h-16 mr-1 rounded-full"  alt="vueicon" />
<img src="src\assets\typescript icon.png" className="h-16 mr-1 rounded-full" alt="tsicon" />
<img src="src\assets\tailwind icon.png" className="bg-white h-16 rounded-full" alt="twicon" />
...
<div className="flex py-2">
<p className="mr-2 ">Stack: </p>
<img src="src\assets\react-icon.png"  className="bg-white h-16 mr-1 rounded-full" alt="vueicon" />
<img src="src\assets\typescript icon.png" className="h-16 mr-1 rounded-full" alt="tsicon" />
<img src="src\assets\tailwind icon.png" className="bg-white h-16 rounded-full" alt="twicon" />
...
<div className=" italic ">auctor augue mauris augue neque gravida in fermentum et
